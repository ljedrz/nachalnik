...
fitting - which is where a shell command is broken at its joints for the permission question, and
where `bullet` reads a list marker, because knowing the shape of the thing being fitted is what
