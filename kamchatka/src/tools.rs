...
pub struct Shell {
    ...
    ///
    /// note: on the struct rather than assigned by [`builtin`], because this is a public type
    /// somebody constructs and registers directly (`builtin` is a convenience, not the only
